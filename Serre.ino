...
#define CHAT_ID "1657003421"
#define BOTtoken "7035316271:AAHqy7T8cTZy_OpWUQYryn5hAfyLZ9Ak2Og"
WiFiClientSecure client;
WiFiClient espClient;
PubSubClient mqttClient(espClient);
Preferences preferences;

const char* ssid = "telenet-8288150";
const char* password = "jemxbs4Twyrz";

const char* mqtt_server = "192.168.0.231";
